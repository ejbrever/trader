...
require (
	...
	github.com/ejbrever/trader/one/database v0.0.0-20201226023622-b703b0666599 // indirect
	github.com/ejbrever/trader/one/purchase v0.0.0-20201226023622-b703b0666599 // indirect
